...
public class PnlDatosPaquete extends JInternalFrame {
	...
	private JTextField textNombreEspectaculo, textCantidadMaxima, textArtistaOrganizador, textDescripcion, textDuracion,
			textCosto, textURL, textRegistro, textCantidadMinima;
