...
public class ManejadorEspectaculo {
	...
	/*
	 * @SuppressWarnings("unchecked") public ArrayList<String> obtenerEspectaculo(){
	 * Conexion conexion = Conexion.getInstancia(); EntityManager em =
	 * conexion.getEntityManager(); Query query =
	 * em.createQuery("select e from Espectaculo e"); List<Espectaculo>
