...
Se cuenta con Base de datos PostgreSQL, entity manager (hibernate), MVC, POO, Maven, una interfaz win desarrollada con swing con el objetivo de ser usada por un rol administrativo del sistema, entre otros...
